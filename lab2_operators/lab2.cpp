...
int main(){
    ...
    // print results 
    cout<< "The height of a free fall object at "<<time<<" seconds is 2" <<height<< " meters " <<endl;

    cout<<"\n------ example 2: arithmetic operator -------"<<endl;
    ...
    //number1 < number2 --> true
    //number1 > 5 --> false
    cout<<"The result of check_or is "<<check_numbers<<endl;

    // OR operator
    bool check_or = (number2 > 10) || (number2 != 3) || (number2 < 1);
    // number2 > 10 --> false
    //number2 != 3 --> true
